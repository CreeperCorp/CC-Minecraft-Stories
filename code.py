...
if (storyFile == 'God Of War'):
  ...
  QuantumSMPSeen = input("Do you want to see every youtuber who has appeared in QuantumSMP?")
  if (QuantumSMPSeen = 'yes'):
    print("ManePear, Boosfer, Willison, Sharpness, Spoke, Reddoons, Sapnap, Baablu, Anchor, Fantst, Dream, Rekrap2, Boomie, YungWillx, Minutech, Spongs, Pangi, JaidenMan, Renderzz, Pentar, Falconu, Skeppy, JumperWho (DEAD), & PrinceZam.")
  ...
  if (ifQuantumSMPTeams == 'yes'):
    ...
    print("The Quadralent (YungWillx-Minutech-Spongs-Pangi-JaidenMan-Renderzz-Pentar-Falconu (Leader)); Allies: Boosfer, Enemies: Anchor-WillyPear")
    print("Pink Lemonade (JumperWho (DEAD)-PrinceZam); Allies: None, Enemies: Anchor & Skeppy")
