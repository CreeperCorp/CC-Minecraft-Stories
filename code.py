...
if (storyFile == 'God Of War'):
  ...
  if (QuantumSMPSeen == 'yes'):
    print("ManePear, Boosfer, Willison, Sharpness (Full Neth), Spoke (NETH HELM (SHARPNESS)), Reddoons, Sapnap, Baablu (NETH CHEST (SHARPNESS)), Anchor, Fantst, Dream, Rekrap2, Boomie, YungWillx, Minutech, Spongs, Pangi, JaidenMan, Renderzz, Pentar, Falconu, Skeppy, JumperWho (DEAD), PrinceZam (NETH BOOTS (SHARPNESS)), LettuceK, HavenHand, MylesYoutube (DEAD), & Jojosolos.")
